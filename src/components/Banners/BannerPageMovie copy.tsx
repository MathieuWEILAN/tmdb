...
const BannerPageMovie = ({
  ...
  return (
    <div
      className={`banner w-full h-screen md:h-[600px] relative md:m-0 ${
    ...
    >
      ...
      <div
        className={`w-full h-full md:h-[600px] absolute top-[140px] md:top-0`}
      >
        <div className="container mx-auto w-full h-full md:py-10 flex flex-col md:flex-row items-center">
          ...
          <div className="w-full mt-4 md:mt-0 px-4 md:px-0 md:pl-10 justify-center space-y-2 md:space-y-4 flex flex-col">
            <div className="w-full overflow-auto flex no-scrollbar">
            ...
            {movie?.homepage && (
              <div className="flex flex-col md:flex-row md:items-end md:space-x-2.5">
                ...
                <a
                  href={movie?.homepage}
                  className="hover:underline font-normal line-clamp-1 md:line-clamp-none"
                >
                  {movie?.homepage}
                </a>
              </div>
